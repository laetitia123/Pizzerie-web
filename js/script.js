...
//     this.sizeName= size;(".pizza-size").text( newPizza.sizeName);
  ...
  $("form#formid").submit(function(event) {
    ...
    $(document).ready(function() {
      ...
      $("#checkout").click(function() {
        ...
        var newTotal=((parseInt(cost1)+parseInt(cost2)+parseInt(cost3))*inputtedNumber+parseInt(price));
        
     alert("the total amount you have to pay are :"+newTotal+"frws")
     alert(inputtedZise)
    //  $("div#pizaaa").append("<p> The price is :" + newTotal + "</span></p>");
     
    //  $("#pizaaa").append("<p> The price is :" + newTotal + "</span></p>");
